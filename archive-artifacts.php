...
<!-- Row for main content area -->
	...
	<?php if ( have_posts() ) : ?>
	<?php $args=array('post_type'=>'artifacts', 'orderby'=>'rand', 'posts_per_page'=>'1');
	$artifact=new WP_Query($args);
	while ($artifact->have_posts()) : $artifact->the_post(); ?>
		<!-- a id="randomItem" class="button right" href="<?php the_permalink() ?>">Random Artifact</a -->
		<?php endwhile; ?>

		<h1 class="entry-title">Artifact Archive</h1>
	...
	-->
		...
		<p class="text-center">
			<a class="button" href="/submit/content/?type=artifacts">Submit an Artifact</a>
		</p>  <!-- .text-center -->
