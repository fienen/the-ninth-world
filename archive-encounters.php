...
<!-- Row for main content area -->
	<article class="small-12 large-12 columns" role="main">
		<h1 class="entry-title">Creature and <abbr title="Non-Player Character">NPC</abbr> Archive</h1>
			...
			<div class="small-12 columns text-center">
  				<ul id="types" class="button-group round">
					...
					<li><button data-filter="*" class="active tiny button secondary">all</button></li>
    					<li><button data-filter=".creature" class="tiny button secondary">creature</button></li>
    					<li><button data-filter=".npc" class="tiny button secondary">npc</button></li>
    					<li><button data-filter=".plant" class="tiny button secondary">plant</button></li>
  				</ul>
	...
	<div class="text-center">
		<a class="button" href="/submit/content/?type=encounters">Submit an Encounter</a>
		<p>Want advice on creating a creature or NPC? Check out Ryan's article, <a href="/quick-dirty-adversaries/">Quick &amp; Dirty Adversaries</a>.</p>
	</div>  <!-- .text-center -->
